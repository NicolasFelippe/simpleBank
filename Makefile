...
.PHONY: postgres redis redis_ping evans createdb dropdb migrateup migratedown sqlc server mock migrateup1 migratedown1 dockerclear db_docs db_schema proto proto_win